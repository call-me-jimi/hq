...
class HQServerDetails(Base):
    __tablename__ = 'hqserver_details'
...
class User( Base ):
    ...
    hq_user_server_host = Column( String(100) )
    hq_user_server_port = Column( Integer )
    hq_user_server_id = Column( String(100) )
...
class Host( Base ):
    ...
    total_number_slots = Column( Integer )
